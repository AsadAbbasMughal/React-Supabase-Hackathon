  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-black text-black ">
      ...
      <main className="flex-1 p-6">
        <h1 className="text-3xl font-bold text-emerald-400">Approved Event Requests</h1>
        <p className="mt-1 text-gray-300">List of approved Event applications will appear below.</p>
      ...
      {approvedLoans.length === 0 ? (
        <tr>
          <td colSpan="6" className="p-4 text-center text-gray-500 italic">
            No approved Event requests found.
          </td>
        </tr>
      ) : (
