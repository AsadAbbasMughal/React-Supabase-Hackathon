    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-black text-black">
      ...
      <aside className="w-full lg:w-64 bg-black text-white p-6">
        ...
        <nav className="space-y-4">
          ...
          <Link
            to="/rejected-loan"
            className="flex items-center gap-3 text-emerald-400 font-semibold transition"
          >
      ...
      <main className="flex-1 p-6">
        <h1 className="text-3xl font-bold text-emerald-400">Rejected Event Requests</h1>
        <p className="mt-1 text-gray-300">List of rejected Event applications will appear below.</p>
              ...
              {rejectedLoans.length === 0 ? (
                <tr>
                  <td colSpan="6" className="p-4 text-center text-gray-500 italic">
                    No rejected Event requests found.
                  </td>
                </tr>
              ) : (
